...
export default function Rules() {
  ...
  return (
    <div
      id="rules"
      className="mx-auto flex w-full max-w-[1019px] flex-col items-center gap-12 px-6 py-16 md:gap-[90px] md:px-0"
    >
      ...
      <div className="relative w-full md:px-[25px]">
        ...
        >
          {tab === 'hacker' ? (
            <ul className="list-disc pl-[30px] text-base leading-[1.6] font-semibold marker:text-[#656565] md:text-[20px] md:leading-[32px]">
              <li>
