...
export default function Rules() {
  ...
  const hackerRules = (
    <ul>
      <li>
        分為初賽與決賽（梅竹大獎），黑客組不允許採用預錄影片 Demo
        取代作品展示，需以現場實際操作展現作品功能，否則不予計分。
      </li>
      <li>
        ...
        <ul>
          ...
          <li>
            ...
            分鐘評審 Q&A。工作人員將於發表 7 分鐘時響短鈴一次，表示發表結束進入
            Q&A。進入 Q&A 環節，12.5 分鐘響短鈴兩次，13
      ...
      <li>
        ...
        <ul>
          ...
          <li>梅竹大獎前三名由評審決定；最佳人氣獎則由現場參賽者投票產生。</li>
        </ul>
      </li>
    </ul>
  )
