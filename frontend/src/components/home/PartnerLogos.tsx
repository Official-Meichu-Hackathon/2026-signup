...
function MainPartnerGrid() {
  return (
    <div className="relative aspect-[812/601] w-full max-w-[812px]">
      <img
        src={logoLogitech}
        alt="Logitech"
        loading="lazy"
        decoding="async"
        className="absolute top-0 left-0 h-[30.283%] w-[47.537%] object-cover"
      />
      <img
        src={logoAmd}
        alt="AMD"
        loading="lazy"
        decoding="async"
        className="absolute top-[10.316%] left-[58.251%] h-[11.647%] w-[36.084%] object-cover"
      />
      <img
        src={logoCloudMosa}
        alt="CloudMosa"
        loading="lazy"
        decoding="async"
        className="absolute top-[42.263%] left-[4.064%] h-[12.978%] w-[39.532%] object-cover"
      />
      <img
        src={logoGoogle}
        alt="Google"
        loading="lazy"
        decoding="async"
        className="absolute top-[38.436%] left-[57.143%] h-[16.805%] w-[38.3%] object-cover"
      />
      <img
        src={logoNxp}
        alt="NXP"
        loading="lazy"
        decoding="async"
        className="absolute top-[67.221%] left-[0.616%] h-[30.616%] w-[46.429%] object-cover"
      />
      <div className="absolute top-[71.547%] left-[52.586%] h-[28.453%] w-[47.414%] overflow-hidden">
        <img
          src={logoAdvantest}
          alt="Advantest 愛德萬測試"
          loading="lazy"
    ...
    <div className="partner-sections mx-auto flex w-full max-w-[1093px] flex-col items-center px-6 pt-2 pb-[53px] md:px-0 md:pt-[130px] md:pb-[117px]">
      ...
      >
        ...
        <img
          ...
          loading="lazy"
          decoding="async"
          className="mt-10 aspect-[219.493/183] w-[100px] object-cover md:mt-[93px] md:w-[219.493px]"
        />
      </div>
      ...
      <div className="partner-block partner-special mt-12 flex w-full flex-col items-center gap-6 md:mt-[149px] md:gap-[60px]">
        ...
        <div className="relative h-[123px] w-[100px] overflow-hidden md:h-[250px] md:w-[203px]">
          <img
            src={logoWtmicro}
            alt="文曄科技"
            loading="lazy"
