...
const VISION_PARAGRAPHS = [
  ...
  '作為全台規模最大的校園黑客松，自 2013 年起，我們每年定期在 9 月下旬到 10 月中旬間舉行大型黑客松年會。我們不只追求限時內的創意爆發，更期盼透過梅竹黑客松，種下改變未來的種子。我們相信，當不同背景、對問題有獨到見解的人們齊聚一堂，便能凝聚出翻轉現狀的力量，並將其轉化為推動進步的永續動能，在瞬息萬變的時代裡，在新竹這個科技城，共同創造具備長遠影響力的嶄新篇章。',
]
