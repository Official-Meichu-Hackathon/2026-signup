  ...
  return (
    <div className="flex w-full items-center justify-center gap-4 pt-6">
      <button
        ...
        onClick={onClick}
        disabled={disabled}
        className={`flex items-center justify-center rounded-full border px-8 py-3 text-base font-black text-white backdrop-blur-2xl backdrop-saturate-150 transition-all duration-300 select-none md:px-16 md:py-4 md:text-lg ${
          disabled
