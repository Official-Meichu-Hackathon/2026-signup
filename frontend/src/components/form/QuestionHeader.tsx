...
const DESCRIPTION_CLASS =
  'mx-4 mt-1.5 text-[0.5rem] leading-snug whitespace-pre-line md:mt-3 md:text-xl md:leading-relaxed'
...
export default function QuestionHeader({
  ...
  return (
    <>
      <h3 className="text-[0.625rem] leading-6 font-semibold text-white md:text-[1.5625rem] md:leading-10">
