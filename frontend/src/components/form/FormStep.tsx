...
export default function FormStep({
  ...
  return (
    <div ref={containerRef} className="scroll-mt-28 pb-5">
      ...
      <div className="relative overflow-hidden rounded-tl-none rounded-tr-[42.734px] rounded-br-[42.734px] rounded-bl-[42.734px] border-[0.272px] border-[rgba(255,255,255,0.2)] bg-[linear-gradient(167deg,rgba(255,255,255,0.14)_0%,rgba(255,255,255,0.03)_99.06%)] px-5 py-8 font-bold text-white shadow-[0_2.722px_8.166px_0_rgba(0,0,0,0.25),inset_0_0.272px_2.178px_0_rgba(255,255,255,0.5)] backdrop-blur-[9.527px] md:rounded-tr-[9.8125rem] md:rounded-br-[9.8125rem] md:rounded-bl-[9.8125rem] md:border md:border-white/20 md:bg-[linear-gradient(167deg,rgba(255,255,255,0.14)_0%,rgba(255,255,255,0.03)_99.06%)] md:px-24 md:py-20 md:shadow-[0_10px_30px_0_rgba(0,0,0,0.25),inset_0_1px_8px_0_rgba(255,255,255,0.5)] md:backdrop-blur-[35px]">
        {/* Sheen overlay (pointer-events-none). */}
        <div className="pointer-events-none absolute inset-0 rounded-tl-none rounded-tr-[42.734px] rounded-br-[42.734px] rounded-bl-[42.734px] bg-gradient-to-b from-white/[0.08] to-transparent md:rounded-tr-[9.8125rem] md:rounded-br-[9.8125rem] md:rounded-bl-[9.8125rem]" />
