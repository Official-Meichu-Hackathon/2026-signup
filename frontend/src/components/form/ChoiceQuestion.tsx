...
export default function ChoiceQuestion({
  ...
  return (
    <div className="py-2 whitespace-pre-line md:py-8">
      ...
      {pdf && (
        <p className="mx-4 mt-1.5 text-[0.5625rem] leading-snug text-white/80 md:mt-3 md:text-xl md:leading-relaxed">
          <a
            href={pdf}
            target="_blank"
      ...
      {description && (
        <p className="mx-4 mt-1.5 text-[0.5625rem] leading-snug whitespace-pre-line text-white/80 md:mt-3 md:text-xl md:leading-relaxed">
          {description}
        </p>
      )}
      <div className="mx-4 mt-3 flex flex-wrap gap-x-8 gap-y-3 md:mt-5 md:gap-x-20 md:gap-y-6">
        {options.map((option) => (
          ...
          >
            ...
            />
            <span className="text-[0.625rem] whitespace-nowrap text-white md:text-xl">
              {option}
            </span>
          </label>
        ))}
